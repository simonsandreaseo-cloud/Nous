    ...
    return (
        <section className="bg-white rounded-[24px] p-6 border border-slate-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden group">
            <div className="flex items-center gap-6 z-10">
                ...
                <div>
                    <h2 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-1">Pulso Editorial</h2>
            ...
            <div className="flex-1 w-full md:w-auto grid grid-cols-3 gap-4 border-l border-slate-100 ml-6 pl-6 z-10">
                <div className="flex flex-col">
                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">Velocidad</span>
                ...
                <div className="flex flex-col">
                    <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1">Próximo Gap</span>
                    <div className="flex items-center gap-2">
