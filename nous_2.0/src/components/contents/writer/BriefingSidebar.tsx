            ...
            <div className="p-6 flex flex-col gap-6">
                <div className="flex flex-col items-center justify-center gap-5 py-10 border-2 border-dashed border-slate-200 rounded-[32px]">
                    ...
                    <div className="text-center px-4">
                        <p className="text-[11px] font-black uppercase tracking-widest text-slate-700">Sin Estructura</p>
                        <p className="text-[10px] font-medium text-slate-400 mt-1 leading-relaxed">
                            {rawSeoData
                                ? 'Genera el briefing con IA o añade secciones manualmente.'
                                : 'Primero realiza la investigación SEO para generar el briefing.'}
                        </p>
                    </div>
                    ...
                    >
                        <div className="absolute inset-0 flex items-center justify-center gap-2 group-hover:-translate-y-full transition-transform duration-500">
                            ...
                            {isPlanningStructure ? 'Diseñando Brief...' : 'Generar Brief con Nous'}
                        </div>
                ...
                {/* Añadir sección manualmente incluso sin briefing */}
                <button
                    onClick={addSection}
        ...
        <div className="p-5 space-y-4 animate-in fade-in duration-300">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    disabled={isPlanningStructure || !rawSeoData}
                    onClick={handlePlanStructure}
                    title="Regenerar briefing con IA"
                ...
                >
                    ...
                    <span>{isPlanningStructure ? 'Generando...' : 'Regenerar Brief'}</span>
                </button>
            </div>
