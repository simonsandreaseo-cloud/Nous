...
export default function BriefingEditorPanel({ 
    editorText = '', 
    onInsertSection, 
    className,
    isSidebar = false
}: BriefingEditorPanelProps) {
    ...
    // Nothing to show if no briefing
            ...
            <div className={cn(isSidebar ? "p-6" : "mx-auto max-w-[700px] px-4 sm:px-8 pt-6", className)}>
                <div className="flex flex-col items-center justify-center gap-5 py-10 border-2 border-dashed border-slate-200 rounded-[32px] bg-slate-50/30">
                    ...
                    <div className="text-center px-4">
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Sin briefing activo</p>
                        <p className="text-[9px] font-medium text-slate-400 mt-1 leading-relaxed max-w-[200px] mx-auto">
                            Genera una estrategia con IA o añade secciones manualmente para comenzar.
                        </p>
                    </div>
                    <button
                        onClick={addSection}
                        className="h-10 px-6 border-2 border-dashed border-indigo-200 rounded-lg text-[10px] font-black text-indigo-500 uppercase tracking-widest hover:bg-indigo-50 transition-all flex items-center gap-2"
                    >
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-3">
                        {/* Section navigator */}
                        <div className="flex items-center gap-1.5 p-1 bg-slate-100/60 rounded-md" onClick={e => e.stopPropagation()}>
                            <button
                        ...
                        >
                            ...
                            <div className="space-y-3">
                                ...
                                <input
                                    ...
                                    className="w-full text-[13px] font-bold text-slate-800 bg-white/50 border border-transparent focus:border-indigo-100 focus:bg-white rounded-md px-3 py-2.5 outline-none placeholder:text-slate-300 transition-all shadow-sm"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    rows={isSidebar ? 4 : 3}
                                    className="w-full text-[11px] font-medium text-amber-900 bg-amber-50/50 border border-amber-100 rounded-lg px-4 py-3 outline-none resize-none leading-relaxed placeholder:text-amber-300 focus:bg-amber-50 transition-all shadow-inner"
                            ...
                            <div className="grid grid-cols-1 gap-2 pt-2">
                                {onInsertSection && (
                                    <button
                                        ...
                                        className="w-full h-11 bg-white border border-indigo-200 rounded-lg text-[10px] font-black uppercase tracking-widest text-indigo-500 hover:bg-indigo-500 hover:text-white hover:border-indigo-500 transition-all flex items-center justify-center gap-2 shadow-sm"
                                    >
                                        <PlusCircle size={14} />
                                ...
                                <button
                                    onClick={addSection}
                                    className="w-full h-11 border-2 border-dashed border-slate-200 rounded-lg text-[10px] font-black uppercase tracking-widest text-slate-400 hover:border-indigo-300 hover:text-indigo-600 hover:bg-slate-50 transition-all flex items-center justify-center gap-2"
                                >
                                    <Plus size={14} />
                                    Nueva Sección
                                </button>
