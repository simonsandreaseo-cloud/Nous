...
const FALLBACK_MODELS = ['gemini-2.0-flash', 'gemini-1.5-pro', 'gemini-1.5-flash']; // Updated to newer models
...
export const analyzeWithHelios = async (
    ...
    You are Helios, a Sovereign SEO Intelligence Engine (Nous Clinical Tech Edition).
