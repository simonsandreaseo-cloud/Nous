...
export default function WriterStudio() {
    ...
    return (
        <div className="flex w-full h-[calc(100vh-6rem)] bg-transparent overflow-hidden rounded-tl-2xl ml-4 mt-4">
            ...
            {/* Main Editor Area */}
            <main className="flex-1 flex flex-col min-w-0 glass-panel border-r-0 rounded-tl-3xl relative">

                {/* Minimal Toolkit / Header */}
                <header className="h-14 border-b border-hairline flex items-center justify-between px-6 bg-transparent z-10 sticky top-0">
                    <div className="flex items-center gap-4">
                        {/* Breadcrumbs or Title could go here */}
                        <div className="text-xs font-light tracking-elegant text-slate-500 uppercase">
                            Borrador sin título
                        </div>
                    </div>
