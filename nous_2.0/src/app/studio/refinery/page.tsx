...
export default function HumanizerPage() {
    ...
    return (
        <div className="w-full h-full bg-[#f7f7f9] text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900">

            <main className="max-w-7xl mx-auto pb-20 px-6 md:px-8">
