...
export async function GET(request: Request) {
  ...
  console.log("[AUTH-SERVER] Callback recibida. Code:", !!code);
  ...
  if (code) {
    ...
    if (!error) {
      console.log("[AUTH-SERVER] Intercambio exitoso. Redirigiendo a:", next);
      ...
      console.error("[AUTH-SERVER] Error en intercambio:", error.message);
    }
  }
