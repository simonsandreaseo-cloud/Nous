...
// The file had it already at the bottom but we missed it. Let's remove our duplication.
const regex = /function TrafficLightItem\(\{ active[\s\S]*?<\/svg>\n\);\n/g;

// remove all
content = content.replace(regex, "");

// re-insert once before ArticleDetailDrawer
...
content = content.replace("export function ArticleDetailDrawer", trafficLightCode + "\nexport function ArticleDetailDrawer");
