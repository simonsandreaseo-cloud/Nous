...
const PROJECT_UUID = 'a287c310-656d-4468-a68c-9386147fe017';
...
async function run() {
    try {
        console.log(`🚀 Testing v3 on UUID: ${PROJECT_UUID}...`);
        ...
        const queryRes = await request(`/v1/projects/${PROJECT_REF}/database/query`, {
            query: sqlQuery
        });
