      ...
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          {SERVICES.map((service, idx) => (
            <motion.div 
              key={service.id} 
              className="group relative p-8 border border-brand-power/5 hover:border-brand-accent transition-colors duration-500 ease-[0.22,1,0.36,1] bg-brand-white flex flex-col justify-between min-h-[380px] interactive"
              variants={{
