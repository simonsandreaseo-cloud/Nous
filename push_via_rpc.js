...
async function run() {
    ...
    let sql = fs.readFileSync('supabase/all_migrations.sql', 'utf8');
    ...
    // Remove the exec_sql creation from the script to avoid conflict, although OR REPLACE handles it
    // We will just execute the whole thing
